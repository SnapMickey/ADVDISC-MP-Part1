...
//		vector1.add(new Vector(new double[] {1,1}, 2));
//		vector1.add(new Vector(new double[] {2,2}, 2));
//		vector1.add(new Vector(new double[] {3,3}, 2));
//		
//		Matrix matrix1 = new Matrix(vector1,3);
//		
